...
2. DXFのセクション別診断情報を一時的にレスポンスへ追加する
3. Tfasから出力するDXF設定（2D/3D、R12互換、ブロック化）を確認する
4. LINE、POLYLINE、TEXT、DIMENSION、INSERT等がどこに格納されているか確認する
5. 図形取得後に、AIへ渡す中間JSONの項目を整理する
